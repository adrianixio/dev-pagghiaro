...
import { Activity, ChevronDown, ChevronRight, LucideAngularModule, Play, PlugZap, RotateCw, Square, Terminal } from 'lucide-angular';
...
describe('ServiceRowComponent', () => {
  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [importProvidersFrom(LucideAngularModule.pick({ Activity, ChevronDown, ChevronRight, Play, RotateCw, Square, Terminal, PlugZap }))],
    });
  });
